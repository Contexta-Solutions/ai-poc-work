      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-[1200px] w-full">
          ...
          <button
            ...
            className="group relative bg-white/60 backdrop-blur-xl rounded-[2rem] p-8 border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_-15px_rgba(20,184,166,0.4)] transition-all duration-500 hover:-translate-y-3 text-left cursor-pointer overflow-hidden"
          >
            ...
            <div className="relative z-10">
              {/* Icon */}
              <div className="bg-gradient-to-br from-teal-400 to-emerald-600 text-white p-4 rounded-2xl shadow-lg shadow-teal-500/30 inline-flex mb-8 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500">
              ...
              <p className="text-slate-500 text-[15px] leading-relaxed mb-8 h-[65px] font-medium">
              ...
              <div className="flex items-center gap-2 text-teal-600 font-bold text-[15px] group-hover:text-teal-700 transition-colors">
                Open Visit Notes
          ...
          <a
            ...
            className="group relative bg-white/60 backdrop-blur-xl rounded-[2rem] p-8 border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_-15px_rgba(168,85,247,0.4)] transition-all duration-500 hover:-translate-y-3 text-left cursor-pointer overflow-hidden no-underline"
          >
            ...
            <div className="relative z-10">
              {/* Icon */}
              <div className="bg-gradient-to-br from-purple-500 to-fuchsia-600 text-white p-4 rounded-2xl shadow-lg shadow-purple-500/30 inline-flex mb-8 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2 text-purple-600 font-bold text-[15px] group-hover:text-purple-700 transition-colors">
                Visit Product
                <svg className="w-5 h-5 group-hover:translate-x-2 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="group relative bg-white/60 backdrop-blur-xl rounded-[2rem] p-8 border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_-15px_rgba(59,130,246,0.4)] transition-all duration-500 hover:-translate-y-3 text-left cursor-pointer overflow-hidden"
          >
            ...
            <div className="relative z-10">
              {/* Icon */}
              <div className="bg-gradient-to-br from-blue-400 to-indigo-600 text-white p-4 rounded-2xl shadow-lg shadow-blue-500/30 inline-flex mb-8 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2 text-blue-600 font-bold text-[15px] group-hover:text-blue-700 transition-colors">
